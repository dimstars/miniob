...
void LockTrace::foundDeadLock(LockID &current, LockTrace::LockID &other,
  ...
  if (itLocks == mLocks.end()) {
    LOG_ERROR("Thread %d own mutex %p and try to get mutex %s:%d, "
              "other thread %d own mutex %s:%d and try to get %p",
    ...
    LOG_ERROR("Thread %d own mutex %p:%s:%d and try to get mutex %s:%d, "
              "other thread %d own mutex %s:%d and try to get %p:%s:%d",
