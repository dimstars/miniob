...
const char *strrc(RC rc) {
  switch (rc) {
    ...
    RC_CASE_STRING(SCHEMA_TABLE_NOT_EQUAL);
    ...
    RC_CASE_STRING(SCHEMA_CONDITION_INVALID);
    RC_CASE_STRING(SCHEMA_CONDITION_FILTER_ALL);
    RC_CASE_STRING(SCHEMA_EXPR_ILLEGAL);
