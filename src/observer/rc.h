...
enum RC {
  ...
  SCHEMA_TABLE_NOT_EQUAL = (SCHEMA | (RCSchema::TABLE_NOT_EQUAL << 8)),
  SCHEMA_TABLE_EXIST = (SCHEMA | (RCSchema::TABLE_EXIST << 8)),
  SCHEMA_TABLE_NAME_ILLEGAL = (SCHEMA | (RCSchema::TABLE_NAME_ILLEGAL << 8)),
  SCHEMA_FIELD_NOT_EXIST = (SCHEMA | (RCSchema::FLIED_NOT_EXIST << 8)),
  SCHEMA_FIELD_EXIST = (SCHEMA | (RCSchema::FLIED_EXIST << 8)),
  SCHEMA_FIELD_NAME_ILLEGAL = (SCHEMA | (RCSchema::FIELD_NAME_ILLEGAL << 8)),
  SCHEMA_FIELD_VALUE_ILLEGAL = (SCHEMA | (RCSchema::FIELD_VALUE_ILLEGAL << 8)),
  ...
  SCHEMA_FIELD_NOT_SUPPORT = (SCHEMA | (RCSchema::FIELD_NOT_SUPPORT << 8)),
  ...
  SCHEMA_CONDITION_INVALID = (SCHEMA | (RCSchema::CONDITION_INVALID << 8)),     // TODO 优化value比较时直接忽略过滤器，如 1!=1.5
  SCHEMA_CONDITION_FILTER_ALL = (SCHEMA | (RCSchema::CONDITION_FILTER_ALL << 8)), // TODO 优化value比较时直接过滤全部记录，如 1==1.5
  SCHEMA_EXPR_ILLEGAL = (SCHEMA | (RCSchema::EXPR_ILLEGAL << 8)),
  ...
  /* corrupt part */ // TODO compile error
