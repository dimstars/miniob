...
public:
   ...
   * @return
   */
  RC create_index(Trx *trx, const char *dbname, const char *relation_name, const char *index_name, const char * const*attribute_names, int attribute_num) ;
   ...
   * @return
   */
  RC create_unique_index(Trx *trx, const char *dbname, const char *relation_name, const char *index_name, const char * const*attribute_names, int attribute_num) ;
   ...
   * @return
   */
  RC insert_record(Trx *trx, const char *dbname, const char *relation_name, int tuple_num, const int value_nums[], const Value values[][MAX_NUM]);
